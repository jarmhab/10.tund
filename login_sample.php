    ...
    // *********************
      ...
      // Kui oleme siia jıudnud, vıime kasutaja sisse logida
			...
			//	echo '</pre>'
				...
				//l2ks edukalt, nyyd oeaks kasutaja sessiooni salvestama
...
//L6PETAME PHP LAADIMISE
  ...
  //trim vıtab ‰ra t¸hikud, tabid ja enterid. stripslashes - eemaldab tagurpidi kaldkriipsud. htmlspecialcpecialchars - eemladab scriptid(muudab koodi tekstiks)
...
<body>
  ...
  <p><p style="color:red;"><?=$create_response->error->message?></p>
